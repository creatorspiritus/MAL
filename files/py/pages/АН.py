...
from функции import Агломерация, РПП, Пвс, Рлч, Vкр, Vт, tр, tрасп, ЧММ, Рлч, Таблица_аэродромов, Наименование, Базовый_УА, Базовый_УА_км, Расчётный_тип_ВС, Категория
...
средняя_стоимость_керосина=100680
...
with col2:
    ...
    РГПП = РПП(аэропорт_назначения[:4])
    РСПП = int(РГПП/365)
