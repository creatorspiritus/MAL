...
from функции import Агломерация, РПП, Парных, Пвс, Рлч, Vкр, Vт, tр, tрасп, ЧММ, Рлч, Таблица_аэродромов, Наименование, Базовый_УА, Базовый_УА_км, Расчётный_тип_ВС, Категория
